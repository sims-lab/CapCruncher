from os import name
import click
from ccanalyser.cli import UnsortedGroup
...
def digest(*args, **kwargs):
    ...
    """
    from ccanalyser.cli.fastq_digest import digest
    digest(*args, **kwargs)
...
def deduplicate_parse(*args, **kwargs):
    ...
    from ccanalyser.cli.fastq_deduplicate import parse
    parse(*args, **kwargs)
...
def deduplicate_identify(*args, **kwargs):
    ...
    from ccanalyser.cli.fastq_deduplicate import identify
...
def deduplicate_remove(*args, **kwargs):
    ...
    """
    from ccanalyser.cli.fastq_deduplicate import remove
    remove(*args, **kwargs)
