...
def annotate(*args, **kwargs):
    ...
    from ccanalyser.cli.alignments_annotate import annotate
...
def filter(*args, **kwargs):
    ...
    """
    from ccanalyser.cli.alignments_filter import filter
    filter(*args, **kwargs)
...
def identify(*args, **kwargs):
    from ccanalyser.cli.alignments_deduplicate import identify
...
def remove(*args, **kwargs):
    ...
    """
    from ccanalyser.cli.alignments_deduplicate import remove
    remove(*args, **kwargs)
