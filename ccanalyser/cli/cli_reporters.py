...
def differential(*args, **kwargs):
    ...
    from ccanalyser.cli.reporters_differential import differential
...
def pileup(*args, **kwargs):
    ...
    from ccanalyser.cli.reporters_pileup import bedgraph
...
def count(*args, **kwargs):
    ...
    """
    from ccanalyser.cli.reporters_count import count
    count(*args, **kwargs)
...
def plot(*args, **kwargs):
    ...
    Heatmaps can also be normalised (--normalise) using either:
     ...
     - ice: `ICE normalisation <https://www.nature.com/articles/nmeth.2148>`_ followed by number of cis interactions
             correction.  
    """
    from ccanalyser.cli.reporters_heatmap import plot
    plot(*args, **kwargs)
...
def store_fragments(*args, **kwargs):
    ...
    """
    from ccanalyser.cli.reporters_store import fragments
...
def store_bins(*args, **kwargs):
    ...
    """
    from ccanalyser.cli.reporters_store import bins
    bins(*args, **kwargs)
...
def store_merge(*args, **kwargs):
    ...
    """
    from ccanalyser.cli.reporters_store import merge
    merge(*args, **kwargs)
