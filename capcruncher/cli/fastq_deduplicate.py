...
def identify(input_files: Tuple, output: os.PathLike = "duplicates.encoded"):
    ...
    Merges the hashed dictionaries generated by the "parse" subcommand and
    identifies read with exactly the same sequence (share an identical hash). Duplicated read
    identifiers (hashed) are output. The "remove" subcommand uses this dictionary
    ...
    try:
        ...
        import numpy as np
        import ujson
        from capcruncher.utils import load_json
...
def remove(
    ...
    try:
        ...
        import ujson
        from multiprocessing import SimpleQueue
        from capcruncher.tools.deduplicate import ReadDuplicateRemovalProcess
