...
```{python}
raw = dedup_stats[['sample', 'total']].rename(columns={'total': 'n_reads'}).assign(stage="raw", stage_order=0)
fastq_dedup = dedup_stats[['sample', 'unique']].rename(columns={'unique': 'n_reads'}).assign(stage="fastq_deduplication", stage_order=1)
